    ...
    <SafeAreaView style={{ flex: 1, alignItems: 'center', backgroundColor: theme.background }}>
      ...
      >
        <View style={styles(theme).topBanner}>
          ...
          <Text style={[styles(theme).titleText, { color: theme.text2, fontSize: 26 }]}>
            About the App
          </Text>
        </View>

        <View style={styles(theme).section}>
          <Text style={[styles(theme).headerText, {fontSize: 25, color: theme.text2, width: '91%'}]}>
            App Design
          </Text>

          <View style={{width:'85%'}}>
            <Text style = {styles(theme).headerText}>
              Coding Language: JavaScript using React Native
            </Text>
          </View>
        </View>
        ...
        <View style={styles(theme).section}>
          ...
          <View style={{width:'90%', marginTop: 18}}>
            <Text style={[styles(theme).normalText, {marginBottom: 10}]}>
              Feel free to reach out to us via our social links if you have any questions about the project or
              any other inquiries.
            </Text>
            <Text style={[styles(theme).normalText, {marginBottom: 10}]}>
