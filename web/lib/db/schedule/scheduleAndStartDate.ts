import { getDatePlusNumShifts, getNumSlotsBetweenDates } from "../../calendarAndDatesUtils/datesUtils";
import { isNight } from "@/lib/schedulingAlgo/rules/nightData";
import { EMPTY, GRACE } from "@/lib/schedulingAlgo/slots/tenterSlot";
import { checkIfNameIsForGracePeriod, isGrace } from "@/lib/schedulingAlgo/rules/gracePeriods";
import { DISCRETIONARY } from "@/lib/data/2024/gracePeriods";
import { UsernameAndIDs } from "./schedule";
